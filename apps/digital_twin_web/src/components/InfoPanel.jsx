...
function InfoPanel({ telemetryData }) {
  ...
  return (
    <div className="info-panel">
      ...
      <div className="stat"><span className="stat-label">Total Zones</span><span className="stat-value">4</span></div>
      <div className="stat"><span className="stat-label">Total Halls</span><span className="stat-value">26</span></div>
      <div className="stat"><span className="stat-label">IoT Devices</span><span className="stat-value">154</span></div>
...
function calculateStats(data) {
  ...
  if (values.length === 0) return { activeDevices: 0, avgOccupancy: 0, avgTemp: 0, avgCO2: 0 };
